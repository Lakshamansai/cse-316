...
int main()
{
  printf("\t\t\t\t\t\t\t\t\t\t\t\tNon-preemtive Scheduling\n\n\n\n");
  long int n,i=0,j=0;
  ...
  printf("\n\nAscending order of the processes according to their Arrival Time\n");
...
printf("\n\n\Calculating Waiting Time and Turn Around Time of each process \n\n");
  ...
  */
  ...
  printf("\n\n\Calculating Waiting Time and Turn Around Time of each process accordin to priority \n\n");
